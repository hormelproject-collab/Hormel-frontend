import Card from "../createBom/components/Card";
...
/>
                ...
                <Card title="Engineering Change Summary" color="rgb(168, 85, 247)" Icon={FaChartLine} />
                <Card title="View BOM Data" color="rgb(99, 102, 241)" Icon={FaEye} />
                <Card title="Download BOM Data" color="rgb(249, 115, 22)" Icon={FaDownload} />
            </div>
